...
# =============================================================================
# ⚠️  À exécuter sur CHAQUE CLONE après le clonage depuis swarm-manager.
...
echo "⚠️  Cette opération va supprimer les clés existantes et en générer de nouvelles."
echo ""
...
echo ""
echo "ℹ️  Si vous vous reconnectez en SSH depuis votre hôte, acceptez la nouvelle clé"
